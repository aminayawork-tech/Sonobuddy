...
export const measurements: Measurement[] = [
  ...
  // ── MSK ──────────────────────────────────────────────────────────────────────
  {
    id: 'supraspinatus-thickness',
    name: 'Supraspinatus Tendon Thickness',
    category: 'musculoskeletal',
    subcategory: 'Shoulder',
    ranges: [
      { min: 5.5, max: 7.5, unit: 'mm', label: 'Normal AP thickness (critical zone)' },
      { min: 4.0, max: 5.4, unit: 'mm', label: 'Thinned — partial-thickness or chronic tear' },
      { max: 4.0, unit: 'mm', label: 'Significantly thinned — full-thickness tear concern' },
    ],
    clinicalNote: 'Measure at the "critical zone" — 1 cm proximal to greater tuberosity insertion. Hypoechoic defect = tear. Compare to contralateral side. Use 12–15 MHz linear probe.',
    tags: ['supraspinatus', 'rotator cuff', 'shoulder', 'tendon', 'msk', 'tear'],
  },
  {
    id: 'achilles-tendon-thickness',
    name: 'Achilles Tendon AP Thickness',
    category: 'musculoskeletal',
    subcategory: 'Ankle/Foot',
    ranges: [
      { max: 6, unit: 'mm', label: 'Normal (measured 2–6 cm above insertion)' },
      { min: 6, max: 8, unit: 'mm', label: 'Borderline — mild tendinopathy' },
      { min: 8, unit: 'mm', label: 'Tendinopathy — thickened, hypoechoic', notes: 'Assess for neovascularity on Doppler' },
    ],
    clinicalNote: 'Measure 2–6 cm proximal to calcaneal insertion (non-insertional). Insertional tendinopathy: measure at bone attachment. Ruptured tendon: gap between fiber ends — measure retraction distance.',
    tags: ['achilles', 'tendon', 'ankle', 'msk', 'tendinopathy', 'rupture'],
  },
  {
    id: 'plantar-fascia-thickness',
    name: 'Plantar Fascia Thickness',
    category: 'musculoskeletal',
    subcategory: 'Ankle/Foot',
    ranges: [
      { max: 4, unit: 'mm', label: 'Normal (calcaneal origin)' },
      { min: 4, max: 6, unit: 'mm', label: 'Thickened — plantar fasciitis' },
      { min: 6, unit: 'mm', label: 'Severely thickened — advanced fasciitis or tear risk' },
    ],
    clinicalNote: 'Measure in longitudinal view at calcaneal origin. Look for hypoechoic change, neovascularity, and calcaneal spur. Partial tear: focal anechoic defect in thickened fascia.',
    tags: ['plantar fascia', 'plantar fasciitis', 'heel', 'msk', 'foot pain', 'calcaneus'],
  },
  {
    id: 'median-nerve-csa',
    name: 'Median Nerve Cross-Sectional Area (CSA)',
    category: 'musculoskeletal',
    subcategory: 'Wrist/Hand',
    ranges: [
      { max: 9, unit: 'mm²', label: 'Normal at carpal tunnel inlet (pisiform level)' },
      { min: 10, max: 14, unit: 'mm²', label: 'Mild CTS — enlarged nerve' },
      { min: 15, unit: 'mm²', label: 'Moderate-severe CTS', notes: 'Clinical correlation with EMG/NCS' },
    ],
    clinicalNote: 'Trace nerve outline at proximal carpal tunnel (pisiform level) in axial view. Wrist:forearm ratio >1.4 is also diagnostic. Look for flattening of nerve within tunnel.',
    tags: ['median nerve', 'carpal tunnel', 'cts', 'wrist', 'msk', 'nerve', 'neuropathy'],
  },
  {
    id: 'patellar-tendon-thickness',
    name: 'Patellar Tendon Thickness',
    category: 'musculoskeletal',
    subcategory: 'Knee',
    ranges: [
      { max: 7, unit: 'mm', label: 'Normal AP thickness (proximal tendon)' },
      { min: 7, max: 10, unit: 'mm', label: 'Mild tendinopathy' },
      { min: 10, unit: 'mm', label: 'Significant tendinopathy ("jumper\'s knee")' },
    ],
    clinicalNote: 'Measure at inferior pole of patella (most common site). Loss of fibrillar pattern + hypoechogenicity = tendinopathy. Partial or complete tear: focal anechoic defect.',
    tags: ['patellar tendon', 'knee', 'jumper knee', 'msk', 'tendinopathy', 'patella'],
  },
  {
    id: 'joint-effusion',
    name: 'Joint Effusion (Knee)',
    category: 'musculoskeletal',
    subcategory: 'Knee',
    ranges: [
      { max: 3, unit: 'mm', label: 'None to trace (normal)' },
      { min: 3, max: 10, unit: 'mm', label: 'Small effusion' },
      { min: 10, unit: 'mm', label: 'Moderate–large effusion', notes: 'Consider aspiration if >1 cm' },
    ],
    clinicalNote: 'Measure suprapatellar pouch in longitudinal view, suprapatellar area with knee extended or in slight flexion (30°). Simple effusion: anechoic. Complex effusion (echoes/debris): consider infection, hemarthrosis, crystal arthritis.',
    tags: ['joint effusion', 'knee', 'msk', 'suprapatellar', 'arthritis', 'aspiration'],
  },
  {
    id: 'hip-effusion',
    name: 'Hip Joint Effusion',
    category: 'musculoskeletal',
    subcategory: 'Hip',
    ranges: [
      { max: 5, unit: 'mm', label: 'Normal anterior capsule-to-neck distance (adults)' },
      { min: 5, unit: 'mm', label: 'Effusion present (or >2 mm asymmetry vs contralateral hip)', notes: 'Pediatric: >2 mm asymmetry = aspiration consideration' },
    ],
    clinicalNote: 'Anterior longitudinal view: measure between anterior joint capsule and femoral neck. Compare bilateral. Pediatric transient synovitis vs septic arthritis: ultrasound cannot distinguish — clinical correlation (fever, WBC, CRP) required.',
    tags: ['hip effusion', 'hip', 'msk', 'joint effusion', 'pediatric', 'transient synovitis', 'septic arthritis'],
  },
  {
    id: 'biceps-tendon',
    ...
    subcategory: 'Shoulder',
    ranges: [
      { min: 3, max: 6, unit: 'mm', label: 'Normal diameter in bicipital groove' },
      { min: 6, unit: 'mm', label: 'Thickened — tendinopathy or tenosynovitis', notes: 'Fluid in sheath: >1–2 mm = tenosynovitis' },
    ],
    clinicalNote: 'Scan in transverse in bicipital groove. Fluid in sheath — assess for tendon instability (medial subluxation or dislocation on shoulder internal rotation). Absent tendon = complete rupture.',
    tags: ['biceps', 'bicipital', 'shoulder', 'msk', 'tendon', 'groove', 'tenosynovitis'],
  },
  {
    id: 'common-extensor-tendon',
    name: 'Common Extensor Tendon (Lateral Elbow)',
    category: 'musculoskeletal',
    subcategory: 'Elbow',
    ranges: [
      { min: 4, max: 7, unit: 'mm', label: 'Normal thickness at lateral epicondyle origin' },
      { min: 7, unit: 'mm', label: 'Thickened — lateral epicondylosis ("tennis elbow")', notes: 'Hypoechoic = enthesopathy' },
    ],
    clinicalNote: 'Scan in longitudinal at lateral epicondyle. Tendinopathy: hypoechoic, thickened, calcifications, neovascularity on Doppler. Partial tear: focal anechoic defect. Full tear: discontinuity — surgical evaluation.',
    tags: ['common extensor tendon', 'tennis elbow', 'lateral epicondylitis', 'elbow', 'msk', 'tendinopathy'],
  },
  {
    id: 'common-flexor-tendon',
    name: 'Common Flexor Tendon (Medial Elbow)',
    category: 'musculoskeletal',
    subcategory: 'Elbow',
    ranges: [
      { min: 4, max: 7, unit: 'mm', label: 'Normal thickness at medial epicondyle origin' },
      { min: 7, unit: 'mm', label: 'Thickened — medial epicondylosis ("golfer\'s elbow")', notes: 'Hypoechoic = enthesopathy' },
    ],
    clinicalNote: 'Scan in longitudinal at medial epicondyle. Associated with UCL (ulnar collateral ligament) injury — evaluate UCL integrity. Ulnar nerve: assess in cubital tunnel for enlargement or subluxation.',
    tags: ['common flexor tendon', 'golfer elbow', 'medial epicondylitis', 'elbow', 'msk', 'tendinopathy'],
  },

  // ── CARDIAC (ADDITIONAL) ──────────────────────────────────────────────────────
  {
    id: 'lv-dimensions',
    name: 'LV End-Diastolic / Systolic Dimensions',
    category: 'cardiac',
    subcategory: 'LV Function',
    ranges: [
      { min: 3.9, max: 5.3, unit: 'cm', label: 'Normal LVIDd (women)' },
      { min: 4.2, max: 5.9, unit: 'cm', label: 'Normal LVIDd (men)' },
      { min: 6.0, unit: 'cm', label: 'Dilated LV — cardiomyopathy concern', notes: 'Confirm with biplane EF' },
    ],
    clinicalNote: 'Measure by M-mode at mitral leaflet tips level in PLAX. Normal LVIDs (systolic): women 2.2–4.0 cm, men 2.5–4.0 cm. Fractional shortening (FS) = (LVIDd − LVIDs)/LVIDd × 100% — normal ≥25%.',
    tags: ['lv', 'lvid', 'left ventricle', 'cardiac', 'echo', 'cardiomyopathy', 'dimensions'],
  },
  {
    id: 'wall-thickness-echo',
    name: 'LV Wall Thickness (IVS + LVPW)',
    category: 'cardiac',
    subcategory: 'LV Function',
    ranges: [
      { min: 0.6, max: 1.0, unit: 'cm', label: 'Normal IVSd and LVPWd' },
      { min: 1.0, max: 1.3, unit: 'cm', label: 'Mildly increased — early LVH' },
      { min: 1.3, max: 1.6, unit: 'cm', label: 'Moderately increased — LVH' },
      { min: 1.6, unit: 'cm', label: 'Severe — HOCM or infiltrative disease', notes: 'Consider cardiac MRI' },
    ],
    clinicalNote: 'Measure IVSd (interventricular septum) and LVPWd (LV posterior wall) at end-diastole in PLAX. Wall thickness ≥15 mm: consider HOCM, amyloid, or Fabry disease.',
    tags: ['lvh', 'wall thickness', 'ivs', 'lvpw', 'cardiac', 'echo', 'hocm', 'hypertrophy'],
  },
  {
    id: 'left-atrium-size',
    name: 'Left Atrial Diameter / Volume',
    category: 'cardiac',
    subcategory: 'Atria',
    ranges: [
      { max: 4.0, unit: 'cm', label: 'Normal LA diameter (PLAX)' },
      { min: 4.0, max: 4.6, unit: 'cm', label: 'Mildly dilated' },
      { min: 4.6, max: 5.2, unit: 'cm', label: 'Moderately dilated — atrial fibrillation/diastolic dysfunction' },
      { min: 5.2, unit: 'cm', label: 'Severely dilated', notes: 'LA volume index >34 mL/m² = dilation' },
    ],
    clinicalNote: 'Diameter: measured in PLAX at systole (between posterior aortic wall and posterior LA wall). Volume index = LA volume ÷ BSA. Enlarged LA: chronic AF, mitral valve disease, diastolic dysfunction.',
    tags: ['left atrium', 'la', 'atrium', 'cardiac', 'echo', 'atrial fibrillation', 'diastolic dysfunction'],
  },
  {
    id: 'rv-systolic-pressure',
    name: 'Estimated RVSP (Pulmonary HTN)',
    category: 'cardiac',
    subcategory: 'Right Heart',
    ranges: [
      { max: 35, unit: 'mmHg', label: 'Normal estimated RVSP' },
      { min: 36, max: 50, unit: 'mmHg', label: 'Mild pulmonary hypertension concern' },
      { min: 50, unit: 'mmHg', label: 'Moderate-severe PH — pulmonology referral', notes: 'RHC for definitive diagnosis' },
    ],
    clinicalNote: 'RVSP = 4 × (TR Vmax)² + estimated RAP. TR Vmax by CW Doppler. RAP estimated from IVC: ≤8 mmHg if IVC ≤2.1 cm and collapses >50%; 15 mmHg if dilated IVC with <50% collapse.',
    tags: ['rvsp', 'pulmonary hypertension', 'tr velocity', 'rv', 'cardiac', 'echo', 'pulmonary'],
  },
  {
    id: 'mitral-valve-inflow',
    name: 'Mitral Valve Inflow (E/A Ratio)',
    category: 'cardiac',
    subcategory: 'Diastolic Function',
    ranges: [
      { min: 0.8, max: 2.0, unit: 'ratio', label: 'Normal E/A ratio (age-variable)' },
      { max: 0.8, unit: 'ratio', label: 'Impaired relaxation (Grade I diastolic dysfunction)' },
      { min: 2.0, unit: 'ratio', label: 'Restrictive filling (Grade III) — elevated filling pressures', notes: 'High filling pressures — urgent HF evaluation' },
    ],
    clinicalNote: 'PW Doppler at mitral leaflet tips (A4C). E = early passive filling, A = late atrial filling. E/A 0.8–2.0 + elevated E/e\' = Grade II (pseudonormal). Tissue Doppler (e\') at septal mitral annulus: normal ≥7 cm/s; lateral ≥10 cm/s.',
    tags: ['mitral', 'e/a ratio', 'diastolic dysfunction', 'cardiac', 'echo', 'heart failure', 'filling pressure'],
  },
  {
    id: 'aortic-valve-area',
    name: 'Aortic Valve Area (AVA)',
    category: 'cardiac',
    subcategory: 'Valves',
    ranges: [
      { min: 2.5, unit: 'cm²', label: 'Normal' },
      { min: 1.5, max: 2.5, unit: 'cm²', label: 'Mild AS' },
      { min: 1.0, max: 1.5, unit: 'cm²', label: 'Moderate AS' },
      { max: 1.0, unit: 'cm²', label: 'Severe AS', notes: '<0.6 cm² = very severe — urgent referral' },
    ],
    clinicalNote: 'Continuity equation: AVA = (LVOT area × LVOT VTI) ÷ AV VTI. Peak AV velocity severe AS ≥4 m/s. Mean gradient severe ≥40 mmHg. Low-flow state can underestimate — dobutamine stress echo if needed.',
    tags: ['aortic valve', 'ava', 'aortic stenosis', 'cardiac', 'echo', 'gradient', 'tavr'],
  },
  {
    id: 'pericardial-effusion-size',
    name: 'Pericardial Effusion Size',
    category: 'cardiac',
    subcategory: 'Pericardium',
    ranges: [
      { max: 5, unit: 'mm', label: 'Small effusion (< 5 mm behind LV in PLAX)' },
      { min: 5, max: 20, unit: 'mm', label: 'Moderate effusion' },
      { min: 20, unit: 'mm', label: 'Large effusion — assess for tamponade physiology', notes: 'RA/RV collapse = tamponade' },
    ],
    clinicalNote: 'Measure posterior LV in PLAX during diastole. Also assess: RA collapse (diastole), RV collapse (diastole), IVC collapsibility. Loculated post-surgical effusions may not be posterior — look in all windows.',
    tags: ['pericardial effusion', 'tamponade', 'pericarditis', 'cardiac', 'echo', 'pericardium', 'pocus'],
  },

  // ── OB ADDITIONAL BIOMETRY ────────────────────────────────────────────────────
  {
    id: 'ob-hc',
    ...
    subcategory: 'Second/Third Trimester',
    ranges: [
      { label: '18 weeks', unit: 'approx', notes: '~161 mm' },
      { label: '20 weeks', unit: 'approx', notes: '~188 mm' },
      { label: '24 weeks', unit: 'approx', notes: '~234 mm' },
      { label: '28 weeks', unit: 'approx', notes: '~272 mm' },
      { label: '32 weeks', unit: 'approx', notes: '~305 mm' },
      { label: '36 weeks', unit: 'approx', notes: '~332 mm' },
      { label: '40 weeks', unit: 'approx', notes: '~351 mm' },
    ],
    clinicalNote: 'Measure outer edge to outer edge at widest biparietal diameter level (thalami + CSP, no cerebellum). Trace or use electronic calipers. Part of 4-measurement EFW along with BPD, AC, FL.',
    tags: ['hc', 'head circumference', 'ob', 'biometry', 'second trimester', 'growth', 'efw'],
  },
  {
    id: 'ob-ac',
    ...
    subcategory: 'Second/Third Trimester',
    ranges: [
      { label: '18 weeks', unit: 'approx', notes: '~133 mm' },
      { label: '20 weeks', unit: 'approx', notes: '~158 mm' },
      { label: '24 weeks', unit: 'approx', notes: '~204 mm' },
      { label: '28 weeks', unit: 'approx', notes: '~248 mm' },
      { label: '32 weeks', unit: 'approx', notes: '~291 mm' },
      { label: '36 weeks', unit: 'approx', notes: '~326 mm' },
      { label: '40 weeks', unit: 'approx', notes: '~367 mm' },
    ],
    clinicalNote: 'Most sensitive biometric parameter for IUGR. Measure at level of portal-umbilical vein junction (liver), stomach bubble visible, spine at 3 or 9 o\'clock. Circular or elliptical fetal abdomen. Small AC: consider IUGR, diabetes if large.',
    tags: ['ac', 'abdominal circumference', 'ob', 'biometry', 'iugr', 'fetal growth', 'second trimester'],
  },
  {
    id: 'ob-efw',
    ...
    subcategory: 'Second/Third Trimester',
    ranges: [
      { label: 'SGA (<10th %ile for GA)', unit: 'category', notes: 'Small for gestational age — IUGR concern' },
      { label: 'AGA (10th–90th %ile)', unit: 'category', notes: 'Appropriate for gestational age — normal' },
      { label: 'LGA (>90th %ile)', unit: 'category', notes: 'Large for gestational age — GDM, macrosomia' },
    ],
    clinicalNote: 'Hadlock formula uses BPD, HC, AC, FL (±5–15% margin of error). SGA: serial biometry every 2–3 weeks. AC <5th percentile is most predictive of IUGR. Macrosomia: EFW >4000g or >90th percentile.',
    tags: ['efw', 'estimated fetal weight', 'ob', 'iugr', 'macrosomia', 'growth restriction', 'biometry'],
  },
  {
    id: 'ob-mca-doppler',
    name: 'MCA PSV (Fetal Anemia Screening)',
    category: 'ob',
    subcategory: 'Fetal Doppler',
    ranges: [
      { max: 1.5, unit: 'MoM', label: 'Normal MCA PSV (<1.5 MoM for GA)' },
      { min: 1.5, unit: 'MoM', label: 'Elevated — moderate-severe fetal anemia concern', notes: 'Refer for fetal blood sampling' },
    ],
    clinicalNote: 'Middle cerebral artery PSV (angle = 0°). >1.5 MoM (multiples of median for GA) predicts moderate-severe fetal anemia with 88% sensitivity. Used in Rh disease, TTTS, hydrops. Normal value increases with GA — use GA-specific tables.',
    tags: ['mca', 'middle cerebral artery', 'fetal anemia', 'ob', 'doppler', 'rh disease', 'hydrops', 'isoimmunization'],
  },
  {
    id: 'ob-umbilical-artery-doppler',
    name: 'Umbilical Artery Doppler (S/D Ratio)',
    category: 'ob',
    subcategory: 'Fetal Doppler',
    ranges: [
      { label: 'Normal S/D ratio', unit: 'GA-dependent', notes: 'Decreases with advancing GA (>28 wks: S/D <3.0 expected)' },
      { label: 'Absent end-diastolic flow (AEDF)', unit: 'abnormal', notes: 'IUGR — consider delivery discussion with MFM' },
      { label: 'Reversed end-diastolic flow (REDF)', unit: 'critical', notes: 'Imminent fetal compromise — urgent MFM/delivery' },
    ],
    clinicalNote: 'Sample umbilical artery free loop. Angle-independent: use S/D ratio or RI. Normal trend: EDV increases as GA advances (ratio falls). AEDF/REDF = severe placental insufficiency — highest urgency in IUGR surveillance.',
    tags: ['umbilical artery', 'doppler', 'iugr', 'ob', 'fetal surveillance', 's/d ratio', 'redf', 'aedf', 'placental insufficiency'],
  },
  {
    id: 'ob-ductus-venosus',
    name: 'Ductus Venosus (DV) Waveform',
    category: 'ob',
    subcategory: 'Fetal Doppler',
    ranges: [
      { label: 'Normal: positive a-wave', unit: 'waveform', notes: 'Forward flow throughout cardiac cycle' },
      { label: 'Abnormal: absent/reversed a-wave', unit: 'waveform', notes: 'Severe cardiac compromise — delivery consideration' },
    ],
    clinicalNote: 'Sample DV (small vessel from umbilical vein to IVC) in sagittal view, at inlet. Used in 11–13 week NT screening (reversed a-wave = cardiac/chromosomal defect risk) and IUGR surveillance (worsening DV = delivery trigger).',
    tags: ['ductus venosus', 'dv', 'ob', 'doppler', 'iugr', 'fetal surveillance', 'first trimester', 'nt'],
  },

  // ── SUPERFICIAL ────────────────────────────────────────────────────────────────
  {
    id: 'lymph-node-size',
    name: 'Lymph Node Size (Short Axis)',
    category: 'superficial',
    subcategory: 'Lymph Nodes',
    ranges: [
      { max: 10, unit: 'mm', label: 'Normal short axis (most sites)' },
      { max: 15, unit: 'mm', label: 'Normal jugulodigastric node (subdigastric)', notes: 'Jugulodigastric up to 15 mm normal' },
      { min: 10, unit: 'mm', label: 'Enlarged — requires characterization (hilum, shape, vascularity)', notes: 'Round + absent hilum = suspicious' },
    ],
    clinicalNote: 'Short axis >10 mm at most sites is abnormal. Malignant features: round shape (L:S ratio <2), absent fatty hilum, peripheral or chaotic vascularity, cystic necrosis. Any suspicious node should be correlated with clinical context and FNA considered.',
    tags: ['lymph node', 'lymphadenopathy', 'neck', 'axilla', 'groin', 'superficial', 'malignancy'],
  },
  {
    id: 'thyroid-isthmus',
    name: 'Thyroid Isthmus Thickness',
    category: 'thyroid',
    subcategory: 'Thyroid',
    ranges: [
      { max: 5, unit: 'mm', label: 'Normal AP thickness' },
      { min: 5, unit: 'mm', label: 'Thickened isthmus — Hashimoto\'s, goiter, or mass', notes: 'Assess for isthmus nodule' },
    ],
    clinicalNote: 'Measure AP in transverse midline. Enlarged isthmus: thyroiditis, isthmus goiter. Any discrete nodule in isthmus: apply TI-RADS criteria (same as lobe nodules). Isthmus nodules can cause dysphagia/stridor earlier due to central location.',
    tags: ['thyroid', 'isthmus', 'hashimoto', 'goiter', 'thyroid nodule', 'tiRads'],
  },
  {
    id: 'parotid-submandibular-gland',
    name: 'Salivary Gland Dimensions',
    category: 'superficial',
    subcategory: 'Salivary Glands',
    ranges: [
      { label: 'Parotid gland', unit: 'size', notes: 'Length 3.5–5 cm; AP 1.5–3 cm; homogeneous, isoechoic to fat' },
      { label: 'Submandibular gland', unit: 'size', notes: 'Length 3–4 cm; AP 1.5–2.5 cm; homogeneous' },
    ],
    clinicalNote: 'Enlarged parotid: infection (parotitis — increased vascularity), Sjögren\'s (heterogeneous), sarcoid, HIV. Ductal calculus: shadowing stone, dilated duct. Mass within: pleomorphic adenoma (most common benign), Warthin\'s tumor (bilateral posterior parotid), mucoepidermoid carcinoma (malignant).',
    tags: ['parotid', 'submandibular', 'salivary gland', 'superficial', 'neck', 'mass', 'stone'],
  },
];
