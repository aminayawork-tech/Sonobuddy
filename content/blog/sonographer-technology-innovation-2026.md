...
1. **Liver elastography technique** — SWE or ARFI. This is standard protocol at volume centers and you will be expected to know it.
2. **Structured reporting** — whatever system your PACS uses. This is no longer optional.
3. **Handheld device operation** — at minimum, know how Butterfly iQ or Clarius works. You'll encounter them in POCUS training and teleultrasound contexts.
4. **3D echo basic acquisition** — if you do any cardiac work, volumetric acquisition is increasingly part of standard echo protocols.
5. **AI tool output interpretation** — understanding what your system's auto-measurements mean and when to override them.
