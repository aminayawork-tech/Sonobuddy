...
### New Graduate
1. **SDMS** (primary CME and professional identity)
2. **State/regional society** (networking and low-cost CME)
3. Skip the rest until you identify your specialty

### Established General Sonographer
1. **SDMS** + **AIUM** (dual journal access for CME, comprehensive coverage)
2. State society for local networking

### Vascular Specialist
1. **SVU** (essential)
2. **SDMS** or **AIUM** for general CME
3. State society

### Echocardiographer
1. **ASE** (essential — guidelines and clinical currency)
2. **SVU** if dual-credentialed (RVT)
3. State/regional cardiovascular society
