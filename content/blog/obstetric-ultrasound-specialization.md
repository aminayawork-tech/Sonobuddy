...
1. Graduate from an accredited program and pass SPI + RDMS (OB/GYN)
2. Work in a general OB/GYN setting or hospital-based OB department for 2–4 years
3. Build volume in anatomy surveys and develop confidence with complex OB imaging
4. Obtain RDMS (FE) credential — often pursued while working, with MFM physicians as mentors
5. Apply to MFM positions (typically require OB/GYN + FE credentials, 3+ years experience)
