...
1. **Understand the three models** — store-and-forward, synchronous guidance, and robotic. The career path and skill requirements differ significantly.
2. **Clarify documentation and liability expectations** before accepting any remote role.
3. **Get familiar with at least one portable/handheld platform** (Butterfly iQ+, Clarius) — these are the most common tools in teleultrasound deployments.
4. **Watch the robotic ultrasound space.** Operators with early experience on robotic platforms will have significant market advantage as commercial deployment expands.
5. **Confirm malpractice coverage explicitly** — don't assume it extends to telehealth work.
