...
1. **Choose a CAAHEP-accredited program with published pass rates above 70%.** Don't guess — the data is public.
2. **Get patient contact experience before applying.** Even part-time work as a MA or CNA for 6 months changes your application tier.
3. **Don't take the SPI cold.** It is the exam most new grads fail first. Use a structured prep course (Pegasus, Hacker's Guide, SPI Review courses from SDMS) and schedule it only when practice scores are consistently above 75%.
