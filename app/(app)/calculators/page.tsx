          ...
          {filtered.map((c) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-2">
                  <code className="text-[10px] font-mono bg-black px-2 py-0.5 rounded" style={{ color: '#ea4743' }}>{c.formula}</code>
                </div>
              </button>
            );
          })}
      ...
      {activeCalc && (
        <div className="px-4 py-4">
          <div className="bg-sono-card border border-sono-border rounded-2xl p-4 mb-4">
            ...
            <code className="text-[11px] font-mono bg-black px-2 py-1 rounded block" style={{ color: '#ea4743' }}>{activeCalc.formula}</code>
          </div>
