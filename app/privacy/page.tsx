...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mb-8">
      <h2 className="text-[15px] font-bold text-slate-900 mb-3">{title}</h2>
      <div className="space-y-3 text-[14px] text-slate-700 leading-relaxed">{children}</div>
    </section>
  );
}
...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-white px-5 pt-12 pb-16 max-w-2xl mx-auto">
      <Link href="/" className="inline-flex items-center gap-1 text-[#0EA5E9] text-sm mb-6 hover:underline">
        ← Back to SonoBuddy
      </Link>

      <h1 className="text-2xl font-bold text-slate-900 mb-1">
        <span className="text-[#0EA5E9]">Sono</span>Buddy Privacy Policy
      </h1>
      <p className="text-xs text-slate-500 mb-8">Last updated: {LAST_UPDATED}</p>

      {/* Summary banner */}
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-8">
        <p className="text-sm text-slate-700 leading-relaxed">
          <strong className="text-slate-900">Short version:</strong> SonoBuddy is a clinical reference tool.
          We do not require an account, we do not sell your data, and we do not share your personal
          information with third parties for advertising. We may collect anonymous usage analytics to
          improve the app.
        </p>
      </div>
      ...
      <Section title="1. Who We Are">
        <p>
          SonoBuddy — Ultrasound Reference is operated by SonoBuddy (&ldquo;we&rdquo;, &ldquo;us&rdquo;,
          or &ldquo;our&rdquo;). We provide a mobile reference application for sonographers and ultrasound
          technologists. Our website is <span className="font-medium text-slate-900">sonobuddy.com</span>.
        </p>
        <p>
      ...
      <Section title="2. Information We Collect">
        <p>
          <span className="font-semibold text-slate-900">No account required.</span> SonoBuddy does not
          require you to create an account. You can use all core features without providing any personal
          information.
        </p>
        <p>
          <span className="font-semibold text-slate-900">Support contact.</span> If you email us for
        ...
        <p>
          <span className="font-semibold text-slate-900">We do not collect:</span> your medical records,
      ...
      <Section title="6. Sharing of Information">
        ...
        <ul className="space-y-2 list-disc pl-4">
          ...
          <li>
            <span className="font-semibold text-slate-900">Business transfer:</span> If SonoBuddy is
      ...
      <Section title="8. Children's Privacy">
        <p>
          SonoBuddy is intended for licensed healthcare professionals and students 17 years of age and
          older. We do not knowingly collect personal information from children under&nbsp;13. If you
      ...
      <Section title="10. Clinical Disclaimer">
        <p>
          SonoBuddy — Ultrasound Reference is a{' '}
          <span className="font-semibold text-slate-900">reference tool only</span> and is not a medical
          device, diagnostic tool, or substitute for clinical judgment. All clinical decisions must
          involve the ordering provider and interpreting physician. Do not enter real patient data into
      ...
      <Section title="11. Changes to This Policy">
        <p>
          If we change our data practices, we will update this page and the &ldquo;Last updated&rdquo;
          date above. Continued use of the app after changes constitutes acceptance of the updated policy.
        </p>
      </Section>
      ...
      <Section title="12. Contact">
        <p>
          ...
          <a href={`mailto:${CONTACT_EMAIL}`} className="text-[#0EA5E9] hover:underline">
            contact us
          </a>.
        </p>
      </Section>
      ...
      <div className="mt-10 pt-6 border-t border-slate-200">
        <p className="text-xs text-slate-400 text-center">SonoBuddy · Made for sonographers</p>
      </div>
    </div>
  );
}
